...
<html lang="en" dir="ltr">
  ...
  <img src="<?php echo URLROOT; ?>/img/login-2.jpeg" alt="Girl in a jacket" width="1400" height="650" style="margin-top:60px">

    <div style="margin-top:100px;left:58%;position:fixed;"class="col-md-5 mx-auto">
